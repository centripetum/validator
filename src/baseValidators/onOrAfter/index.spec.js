...
describe('baseValidators:onOrAfter', () => {
  it(`returns Left(NOT_ON_OR_AFTER_DATE_TIME error) if the value date-time is before the testValue date-time`, () => {
  ...
  it(`returns Right(Just(value)) if the value date-time is after the testValue date-time`, () => {
